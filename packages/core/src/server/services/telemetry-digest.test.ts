...
describe("telemetry digest", () => {
  ...
  it("builds the previous-day summary from the DB queries", async () => {
    ...
    expect(summary).toEqual({
      ...
      appUrl: "https://heybap.com",
      appUrlDomain: "heybap.com",
  ...
  it("formats a readable Slack message", () => {
    ...
    expect(message).toContain("Bap daily ops digest for 2026-03-12");
    expect(message).toContain("App URL domain: heybap.com (APP_URL)");
