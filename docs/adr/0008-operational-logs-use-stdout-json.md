...
Operational Logs use `event.kind="operational_log"` and a dotted snake case `event` field. `bap.event.name` remains reserved for Canonical Service Events and Client Observations.
