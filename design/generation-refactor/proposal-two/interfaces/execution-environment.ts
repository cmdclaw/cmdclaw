/**
 * Provider-neutral execution environment seam.
 *
 * This module owns sandbox mechanics. It does not know generation statuses or
 * product reasons for pausing/completing/cancelling.
 */
...
export type AcquireEnvironmentInput = {
  ...
  providerPreference?: "docker" | "daytona" | "e2b";
