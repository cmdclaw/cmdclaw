...
const { getSessionMock, findFirstMock, insertValuesMock, updateSetMock, updateWhereMock } =
  vi.hoisted(() => ({
...
import { getWhatsAppStatusEndpoint, postWhatsAppLinkCode, postWhatsAppStart } from "./handlers";
...
describe.each([
  ["getWhatsAppStatusEndpoint (GET /api/whatsapp/status)", getWhatsAppStatusEndpoint],
