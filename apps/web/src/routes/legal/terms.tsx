...
export const Route = createFileRoute("/legal/terms")({
  head: () => ({
    meta: [
      { title: "Terms of Use - Bap" },
      { name: "description", content: "Terms of use for Bap services" },
    ],
  }),
  component: TermsPage,
});
...
function TermsPage() {
  return (
    <article className="mx-auto">
      ...
      <p className="leading-7 [&:not(:first-child)]:mt-6">
        The purpose of the Site is to provide the following services online: Presentation of the Bap
        offer and services (hereinafter referred to as the &quot;Services&quot;). Each Service
        presented on the Site is accompanied by a description stating its essential characteristics.
        This description may include descriptions, photographs, and graphics that are provided for
        illustrative purposes only and may be subject to modification/update on the Site.
      </p>
      ...
      <p className="leading-7 [&:not(:first-child)]:mt-6">
        ...
        Client account. Select the Services they wish to subscribe to. Provide the necessary
        information in the Client order form (name, address, email address, date of birth, phone
        number, etc.). Confirm their acceptance of the General Terms. Confirm their acceptance of
        the order for the Services. Choose their payment method. Make the payment for the Services.
        Unless expressly stated on the Site, the Client will not be able to modify their order once
        it has been validated, and the order will be final and binding. Upon receipt of the payment
        for the Services included in the order, the Service Provider will send a confirmation email
        to the Client at the email address provided by the Client. The confirmation email will
        summarize the essential characteristics of the ordered Service(s), the total price, and any
        other relevant information. It will also include a tracking number for the Client&apos;s
        order. By placing an order on the Site, the Client expressly agrees to receive an electronic
        invoice from the Service Provider. However, they may request a paper invoice by contacting
        Customer Service. To combat fraud, the Service Provider or its payment or delivery service
        providers may request additional documentation from the Client or contact them at the time
        of order acceptance and/or shipment. In the event of the Client&apos;s unjustified refusal
        to provide the requested information and/or documentation, the Service Provider reserves the
        right to refuse or cancel the order without any possibility of dispute. The Service Provider
        also reserves the right to refuse or cancel the order of any Client who has provided
        inaccurate information, has not made payment for the Services, has a dispute regarding
        payment for a previous order, or presents an abnormally high level of ordering.
      </p>
