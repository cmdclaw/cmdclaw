 ...
 *
 * Development/testing landing page that links to the internal preview surfaces. These
 * internal pages were never in the old proxy's `protectedRoutes` list, so they carry no
 * session guard here — they render inside the root layout only. The exact public URL
 * (`/internal`) is preserved via the `internal/index` file route.
 */
