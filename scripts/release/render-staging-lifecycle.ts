...
const stagingResources: Resource[] = [
  { kind: "postgres", name: "cmdclaw-postgres-staging" },
  { kind: "key-value", name: "cmdclaw-redis-staging" },
  ...
  { kind: "service", name: "cmdclaw-victoria-logs-staging" },
  { kind: "service", name: "cmdclaw-victoria-traces-staging" },
  { kind: "service", name: "cmdclaw-vector-staging" },
  { kind: "service", name: "cmdclaw-alertmanager-staging" },
  { kind: "service", name: "cmdclaw-vmalert-staging" },
  { kind: "service", name: "cmdclaw-grafana-staging" },
  { kind: "service", name: "cmdclaw-web-staging" },
  { kind: "service", name: "cmdclaw-mcp-staging" },
  { kind: "service", name: "cmdclaw-worker-staging" },
];
